...
export const useDataStore = defineStore('data',{
  state: () => ({
      lists:[{ id: 1, name: '製作表單', project: "Vue", totalTime: 0, distractTime: 0, },{ id: 2, name: '製作表單2', project: "Vue", totalTime: 0, distractTime: 0, },{ id: 3, name: '製作表單3', project: "Vue", totalTime: 0, distractTime: 0, }],
      endLists:[],
